  ...
  constructor(object, domElement) {
    ...
    function onPointerDown(event) {
      ...
      if (pointers.length === 0) {
        ...
        scope.domElement.addEventListener('mousedown', (event) => {
          if (event.which === 1) {
            scope.leftButtonDown = true;
          } else if (event.which === 3) {
            scope.rightButtonDown = true;
          }
        ...
        scope.domElement.addEventListener('mouseup', (event) => {
          if (event.which === 1) {
            scope.leftButtonDown = false;
          } else if (event.which === 3) {
            scope.rightButtonDown = false;
          }
    ...
    function onMouseDown(event) {
      ...
      if (scope.leftButtonDown && scope.rightButtonDown) {
        mouseAction = MOUSE.ROTATE;
      } else {
        if (scope.rightButtonDown) {
